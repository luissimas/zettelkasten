:PROPERTIES:
:ID: e87b6d14-0282-42cc-b258-a344074b3f77
:END:
#+title: Tratamento algébrico de vetores
...
[[file:basecanonica.png.org][basecanonica.png]]
...
[[file:definicaovetorcartesiano.png.org][definicaovetorcartesiano.png]]
...
[[file:vetorpordoispontos.png.org][vetorpordoispontos.png]]
...
[[file:baseortogonalespacial.png.org][baseortogonalespacial.png]]
...
[[file:planosvetoresespaciais.png.org][planosvetoresespaciais.png]]

A intersecção desses planos divide o espaço em oito regiões denominadas octantes.

[[file:octantes.png.org][octantes.png]]
...
Todas as definições válidas para o plano são análogas às do espaço, porém é necessário considerar o eixo \(z\) em todas elas. - Dois vetores \(\vec{v}=(x_1,y_1,z_1)\) e \(\vec{u}=(x_2,y_2,z_2)\) são iguais se e somente se \(x_1=x_2,y_1=y_2,z_1=z_2\) - Sejam \(A(x_1,y_1,z_1)\) e \(B(x_2,y_2,z_2)\) dois pontos no espaço, então \(\overrightarrow{AB}=(x_2-x_1,y_2-y_1,z_2-z_1)\) - Se \(A(x_1,y_1,z_1)\) e \(B(x_2,y_2,z_2)\) são pontos extremos de um segmento, o ponto médio \(M\) de \(AB\) é \(M\left(\frac{x_1+x_2}{2},\frac{y_1+y_2}{2},\frac{z_1+z_2}{2}\right)\) - O módulo do vetor \(\vec{v}=(x,y,z)\) é dado por \(|\vec{v}|=\sqrt{x^2+y^2+z^2}\)
