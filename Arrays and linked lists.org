:PROPERTIES:
:ID: 6DB789D2-D84C-44D5-ADDC-0FFE19376404
:END:
...
[[file:../Attachments/IPA/linkedlist.png.org][../Attachments/IPA/linkedlist.png]]

The nature of linked lists implies in some interesting characteristics: - Items can be easily added or deleted without the need to move the existing ones. - The elements can only be read sequentially, random access isn't possible.
