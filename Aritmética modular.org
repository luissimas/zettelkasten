:PROPERTIES:
:ID: d3f57400-f927-486b-b084-04216adf0135
:END:
...
#+begin_quote
Dado um número inteiro positivo \(n\) e \(a, b \in \mathbb{Z}_n\), definem-se as operações da aritmética modular: - Adição: \(a \oplus b = (a + b) \mod n\) - Multiplicação: \(a \otimes b = (a \cdot b) \mod n\) - Subtração: \(a \ominus b = |a - b| \mod n\) - Divisão: \(a \oslash b = a \otimes b^{-1}\)
