:PROPERTIES:
:ID: ae1577a5-7fbd-456c-93ac-a134bfebca15
:END:
#+title: O plano
#+filetags: :Equa:
...
[[file:eqgeralplano.png.org][eqgeralplano.png]]
...
[[file:eqvetorialplano.png.org][eqvetorialplano.png]]
...
[[file:eqvetorialparalelogramo.png.org][eqvetorialparalelogramo.png]]
...
[[file:anguloplanos.png.org][anguloplanos.png]]
...
[[file:planosperpendiculares.png.org][planosperpendiculares.png]]
...
[[file:parperpretaplano.png.org][parperpretaplano.png]]
...
[[file:retacontidanoplano.png.org][retacontidanoplano.png]]
...
2. Podemos definir um ponto \(A\) que esteja contido em ambos os planos e um vetor \(\vec{v}\) que seja simultaneamente ortogonal aos vetores normais dos dois planos, ou seja, \(\vec{v}\) é definido pelo [[id:209d2b46-65a2-491a-8afc-1d2b665024ac][produto vetorial]] entre os vetores normais dos dois planos. A partir disso podemos [[file:A reta#Equação vetorial.org][definir a reta através de um ponto e um vetor]].

[[file:intersecaodoisplanos.png.org][intersecaodoisplanos.png]]
...
Para determinar a intersecção de uma reta \(r\) com um plano \(\pi\) basta encontrar um ponto \(A\) tal que \(A\in r\) e \(A\in\pi\) simultaneamente. Isso pode ser feito substituindo cada uma das variáveis da equação geral do plano pela uma [[file:A reta#Equações paramétricas.org][equação paramétrica da reta]] correspondente àquela coordenada. Dessa forma é possível encontrar um parâmetro \(t\) que indica qual ponto da reta \(r\) pertence também ao plano \(\pi\).
