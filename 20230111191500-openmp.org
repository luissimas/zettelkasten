...
int calc(int start, int finish) {
  if (finish - start <= MIN_BLOCK) {
    ...
    printf("Bloco pequeno o bastante ([%d, %d])! Calculando...\n", start,
           finish);
...
Dividindo [0, 64]
Dividindo [64, 128]
Bloco pequeno o bastante ([64, 96])! Calculando...
Bloco pequeno o bastante ([96, 128])! Calculando...
Bloco pequeno o bastante ([128, 160])! Calculando...
Bloco pequeno o bastante ([160, 192])! Calculando...
Bloco pequeno o bastante ([192, 224])! Calculando...
Bloco pequeno o bastante ([224, 256])! Calculando...
Bloco pequeno o bastante ([0, 32])! Calculando...
Bloco pequeno o bastante ([32, 64])! Calculando...
Soma: 256
#+end_example
