:PROPERTIES:
:ID: 0BFFA3F6-3C84-4910-A560-659842D5AFEA
:END:
#+title: HTTP
...
** Códigos de resposta
As respostas HTTP sempre contém um /status code/ que permite a fácil depuração da resposta. Cada status indica o que houve com a requisição e qual o estado da resposta fornecida pelo servidor. Existem diversos status codes, para um overview sobre os principais acesse [[https://httpstatuses.com/][esse link]].
