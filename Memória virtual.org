:PROPERTIES:
:ID: 668d9bde-080b-47e3-86e7-f4335e115e7e
:END:
...
** Tabela de páginas
A "tradução" dos endereços virtuais em endereços físicos é feita por um módulo da /CPU/ chamado /Memory Management Unit (MMU)/, que controla tanto a memória virtual quando a [[id:29d7535b-aea5-408f-955f-adab80e42e9d][memória cache]]. Para efetivamente traduzir os endereços, utiliza-se uma /tabela de páginas/, que associa os endereços virtuais aos endereços físicos. O endereço virtual é dividido em um /número de página virtual/ nos bits mais significativos e um /deslocamento/ (que indica o endereço relativo ao início da página virtual) nos bits menos significativos.

#+caption: estruturatabeladepaginas
[[file:../Attachments/SO/estruturatabelapaginas.png.org][../Attachments/SO/estruturatabelapaginas.png]]
...
#+caption: entradatabeladepaginas
[[file:../Attachments/SO/entradatabeladepaginas.png.org][../Attachments/SO/entradatabeladepaginas.png]]
