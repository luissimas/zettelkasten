:PROPERTIES:
:ID: 3bd813db-80ef-4bfc-8870-32767494e4ca
:END:
...
Note que as [[./Derivadas%20parciais.md][derivadas parciais]] de \(f\) em \((x_0, y_0)\) são também derivadas direcionais particulares. \(\frac{\partial f}{\partial x}{(x_0, y_0)}\) e \(\frac{\partial f}{\partial y}{(x_0, y_0)}\) são, respectivamente, as derivadas direcionais de \(f\) no ponto \((x_0, y_0)\) e nas direções dos vetores \(\vec{i} = (1,0)\) e \(\vec{j} = (0,1)\).
