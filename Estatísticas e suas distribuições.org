:PROPERTIES:
:ID: B6E78CF6-3DE3-4E47-AD83-C184602C48F4
:END:
#+title: Estatísticas e suas distribuições
#+filetags: :Distribui:
...
\end{cases}
\]
e quando \(X\) é uma [[id:8493FE1A-2570-4A22-924C-3314BC2BFFA2][variável aleatória contínua]] \(f(x_1,\dots,x_n|\theta)\) é tal que
\[
...
As seguintes relações são muito úteis, pois nos permitem relacionar a [[id:1243F180-52E6-41B3-A99B-3D0C89ECA3FE][esperança e variância]] das variáveis com a esperança e variância amostrais.
...
*** Proporção amostral
Podemos utilizar o /T.L.C./ para aproximar também a distribuição da proporção amostral \(\hat{p}\) pela [[file:Variáveis aleatórias contínuas#Distribuição normal.org][distribuição normal]]. Nesse caso temos:
