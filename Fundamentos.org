:PROPERTIES:
:ID: 47C87DEB-B16A-4292-9CD7-12AF1294C719
:END:
#+title: Fundamentos
#+filetags: :Arquitetura:
...
[[file:barramentobasico.png.org][barramentobasico.png]]

** Arquitetura
Atributos visíveis para o programador, ou seja, atributos que têm impacto direto na execução de algum programa. - Conjunto de instruções básicas - Número de bits para representar dados - Mecanismos de input e output

** Organização
Atributos não visíveis para o programador, são responsabilidade do projetista de hardware. A forma como os elementos computacionais estão dispostos e organizados através de conexões que implementam as especificações da [[file:Fundamentos#Arquitetura.org][Arquitetura]] no hardware. - Sinais de controle - Tecnologia de transistores - Tecnologia de memória
...
[[file:fundamentos.pdf.org][fundamentos.pdf]]
