:PROPERTIES:
:ID:       15bcf206-1515-43a6-a64e-8e4f832ccdd5
:END:
#+title:Convolução

A convolução é uma operação matemática muito útil no [[id:daf167f1-1b09-497b-b622-428ba8fe7e1e][Processamento Digital de Imagens]], sendo um importante *operador linear* para implementar a [[id:a217fef9-f014-414b-b188-fe714dc3b4e4][Filtragem de imagens]]. O processo de convolução consiste em, dadas duas funções, obter uma terceira que consiste na soma do produto dessas funções ao longo da região na qual elas são sobrepostas.
