...
1.  Breadth-First (Busca em Largura)
...
2.  Depth-First (Busca em profundidade)
...
1.  Busca pela melhor escolha (best-first)
...
#+attr_org: :width 600
```
![](../Attachments/IA/evolutionalgorithm.png)
...
#+attr_org: :width 700
```
![](~/dox/vault/Attachments/IA/overfittingunderfitting.png)
...
#+attr_org: :width 700
```
![](~/dox/vault/Attachments/IA/mltypes.png)
...
#+attr_org: :width 700
```
![](~/dox/vault/Attachments/IA/decisiontree.png)
...
#+attr_org: :width 800
```
![](../Attachments/IA/neuralnetwork.gif)
...
#+attr_org: :width 600
```
![](../Attachments/IA/backwardpropagation.gif)
...
1.  Perceptron
    ...
    #+attr_org: :width 600
    ```
    ![](../Attachments/IA/artificialneuronmodel.png)
...
#+attr_org: :width 500
```
![](../Attachments/IA/confusionmatrix.png)
