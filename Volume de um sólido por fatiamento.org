:PROPERTIES:
:ID: 5c9711cc-542b-4260-87c3-10254e3ba684
:END:
#+title: Volume de um sólido por fatiamento

* Volume de um sólido por fatiamento
Para calcular o volume de um sólido por fatiamento usamos uma ideia muito similar a usada para compreender as [[id:4945bd65-2137-42db-886a-d1de54a46002][integrais definidas]] (tanto que usamos essas integrais nesse contexto). Se desejamos calcular o volume de um sólido em um intervalo \([a,b]\), devemos primeiro calcular a área de uma "fatia" que representa uma das secções transversais desse sólido, como mostra a figura:
[[file:areafatiasolido.png.org][areafatiasolido.png]]
