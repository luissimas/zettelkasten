:PROPERTIES:
:ID: b50f1f5b-c4e0-4891-bc66-684a656398a1
:END:
#+title: Classificação de grafos
...
** Subgrafo
Um grafo \(H = (T,B)\) é /subgrafo/ de outro grafo \(G = (V,A)\) se as seguintes condições forem satisfeitas: - \(T \subseteq V\) - \(B \subseteq A\) - Cada aresta de \(B\) tem os mesmos extremos em \(H\) e \(G\). Caso \(G\) seja orientado, as arestas de \(H\) precisam ter a mesma orientação.
