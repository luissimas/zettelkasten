:PROPERTIES:
:ID: 2bccca7b-5699-4ec0-ae08-e3f2d516d596
:END:
#+title: Regra da cadeia em funções de várias variáveis

* Regra da cadeia em funções de várias variáveis
A regra da cadeia nos permite calcular derivadas de funções compostas. Para calcular a derivada de funções de várias variáveis usando esse método, é preciso compor a função a ser derivada com uma /curva/ para então calcular sua derivada utilizando o [[file:Vetor gradiente .org][ vetor gradiente]].
