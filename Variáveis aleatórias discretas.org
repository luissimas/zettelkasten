:PROPERTIES:
:ID: 460c2c8b-08fc-4830-8475-d3d500b38b4f
:END:
...
Esse tipo de experimento pode ser interpretado como a *realização de \(n\) /ensaios de Bernoulli/ indepentendes, anotando-se o número de sucessos obtidos.* Note que a utilização de \(\binom{n}{x}\) nos permite considerar as \(n\) [[file:Contagem#Combinação.org][combinações]] possíveis desprezando a ordem.
