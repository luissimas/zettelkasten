:PROPERTIES:
:ID: 9A9729FB-2119-409D-A00D-CFE57CADD80A
:END:
#+title: Relações

* Relações
Uma relação \(R\) é um [[id:D59212F8-7822-45C5-A37A-88C3198645A3][conjunto]] de /tuplas/ \((a_1,a_2, \dots, a_n)\) com \(a_1 \in A_1\), \(a_2 \in A_2\), \(\dots\), \(a_n \in A_n\). Note que \(R\) é necessariamente um subconjunto do conjunto definido pelo produto cartesiano [[id:F7624B42-4E85-4CD2-9261-46D467F421E1][produto cartesiano]] \(A_1 \times A_2 \times \dots \times A_n\) Essas tuplas de objetos são relacionadas através de uma *lei de associação*.
