:PROPERTIES:
:ID: C3D5CF02-7C9A-470B-AE4B-C49C7EF7E6CA
:END:
#+title: Grafos
...
Um grafo é definido por um par \((V, A)\) onde: - \(V\) é um conjunto qualquer (de vértices). - \(A\) é uma relação em \(V\), ou seja, um subconjunto do produto cartesiano \(V \times V\).
