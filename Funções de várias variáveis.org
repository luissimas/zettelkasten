:PROPERTIES:
:ID: f48013c5-d5cc-48bb-80ea-82f62b61942c
:END:
#+title: Funções de várias variáveis

* Funções de várias variáveis
Em aplicações reais geralmente as funções relacionam o valor de mais de uma variável a
algum outro valor. Em geral as funções de duas variáveis são estudadas com mais ênfase, pois a partir delas é possível generalizar os resultados para quaisquer funções de \(n\) variáveis.
