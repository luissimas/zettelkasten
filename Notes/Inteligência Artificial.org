...
$$\sum_{k=1}^d{\frac{p_k + n_k}{p+n}H(E_k)}$$

no qual:

$$p_k = \frac{n_k}{n}$$

onde $n_k$ corresponde ao número de exemplos da classe $k$ e $n$ corresponde ao número total de exemplos no conjunto de dados.
