# Quicksort
Quicksort is one of the fastest sorting algorithm, and it is used in a lot of applications. It uses the principles of [[Notes/Divide and conquer|divide and conquer]].
