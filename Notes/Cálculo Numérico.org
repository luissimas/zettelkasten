...
O Método dos Mínimos Quadrados consiste em, dado um *conjunto* de $n$ *pontos* $\{(x_0, f(x_0)), (x_1, f(x_1)), \dots, (x_{n-1}, f(x_{n-1}))\}$, *determinar uma função* $g(x)$ que *melhor se aproxime* de $f$.
