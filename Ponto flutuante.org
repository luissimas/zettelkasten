:PROPERTIES:
:ID: 188d0ebb-2312-41da-87d5-c421448153cf
:END:
...
[[file:floatingpoint.png.org][floatingpoint.png]]
...
[[file:floatingpointieee.png.org][floatingpointieee.png]]
...
[[file:adicaofloatingpoint.png.org][adicaofloatingpoint.png]]

[[file:implementacaoadicaofloatingpoint.png.org][implementacaoadicaofloatingpoint.png]]

** Implementação em MIPS
Na arquitetura [[id:35611088-86e7-4d80-b751-bdc56e12dc0b][MIPS]] utiliza-se um *coprocessador* dedicado chamado /Coprocessor 1/ ou /Floating Point Unit (FPU)/ para realizar as operações relacionadas a números /FP/. São reservados \(32\) registradores /FP/: \(\text{\$f0}, \text{\$f1}, \dots, \text{\$f31}\). Vale lembrar que como todos os registradores MIPS são de \(32\) /bits/, é necessário o uso de dois registradores em conjunto para armazenas os números de precisão dupla.

--------------

created: 17/05/2021

[[file:Ponto_Flutuante.pdf.org][Ponto_Flutuante.pdf]]
